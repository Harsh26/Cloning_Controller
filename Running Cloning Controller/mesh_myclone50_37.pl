...
starttar:-
    consult("platform.pl"), 
    start_tartarus(localhost,15037,30),
    retractall(need_train(_)),
assert(need_train([2,2])),
...
assert(all_nodes([15000,15001,15002,15003,15004,15005,15006,15007,15008,15009,15010,15011,15012,15013,15014,15015,15016,15017,15018,15019,15020,15021,15022,15023,15024,15025,15026,15027,15028,15029,15030,15031,15032,15033,15034,15035,15036,15037,15038,15039,15040,15041,15042,15043,15044,15045,15046,15047,15048,15049])),
    ...
    assert(platform_number(37)).

attachneighbour:-
assert(node_neighbours([15000,15001,15002,15003,15004,15005,15006,15007,15008,15009,15010,15011,15012,15013,15014,15015,15016,15017,15018,15019,15020,15021,15022,15023,15024,15025,15026,15027,15028,15029,15030,15031,15032,15033,15034,15035,15036,15038,15039,15040,15041,15042,15043,15044,15045,15046,15047,15048,15049])).
